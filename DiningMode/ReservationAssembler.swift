...
extension ReservationAssembler {
    ...
    func createReservation(fromJsonTerminatedFile fileName: String) -> Reservation? {
        //Normally, I would write this a little more generically to handle files w/o extension
        //Thus the ungainly argument lable ;-)
